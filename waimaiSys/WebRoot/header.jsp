    	...
    	<div class="csr-header">
            <div class="header-content">
                <div id="left" style="width: 40%">
                    <div class="waimai">
                        <c:if test="${user!=null }">
			            	<a class="j-login new-login-btn fr" href="${cp}index/zhuxiao/1" rel="nofollow">退出登录</a>
			            ...
			            <c:if test="${user==null }">
				            <a class="j-login new-login-btn fr" href="${cp}gologin/1" rel="nofollow">登录</a>
				            <a class="j-register new-register-btn fr" href="${cp}goreg/1" rel="nofollow">注册</a>
			            </c:if>
                    </div>
                </div>
                <div id="right">
                    <ul id="links">
                        ...
                        <c:if test="${!empty address}">
                        	<a href="${cp}index/find" class="active">点外卖</a>
                        </c:if>
                        <c:if test="${!empty address}">
                        	<a href="${cp}getAddress.jsp" class="active">点外卖</a>
                        </c:if>
                        </li>
